...
export class MarkdownEditor {
  ...
  setupEditor(content) {
    ...
    const extensions = [
      ...
      this.fontSizeCompartment.of(this.createFontSizeTheme(16)),
  ...
  customKeymap() {
    return [
      ...
      { key: "Mod-b", run: () => { this.toggleBold(); return true }},
      { key: "Mod-i", run: () => { this.toggleItalic(); return true }},
      { key: "Mod-j", run: () => { this.toggleUnderline(); return true }},
      { key: "Mod-h", run: () => { this.toggleHighlight(); return true }},
      { key: "Mod-k", run: () => { this.insertLink(); return true }},
      { key: "Mod-Shift-x", run: () => { this.toggleStrikethrough(); return true }},
